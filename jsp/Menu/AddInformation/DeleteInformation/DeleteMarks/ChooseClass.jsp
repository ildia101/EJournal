...
<html lang="uk-UA">
  ...
  <body>
    ...
    <div id="wrapper">
      <div id="input-field">
        <center>
          <form method="POST" action="${pageContext.request.contextPath}/jsp/Menu/AddInformation/DeleteInformation/DeleteMarks">
            <input type="hidden" name="Deleting" value="Marks" />
            <p class="input-background">
              <span class="text">Оберіть клас для видалення оцінок:</span>
