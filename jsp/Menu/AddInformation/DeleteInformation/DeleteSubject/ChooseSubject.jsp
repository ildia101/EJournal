...
<html lang="uk-UA">
  ...
  <body>
    <a href="${pageContext.request.contextPath}/jsp/Menu/AddInformation/DeleteInformation">Повернутися</a>
    <div id="wrapper">
      <div id="input-field">
        <center>
          <form method="POST" action="${pageContext.request.contextPath}/jsp/Menu/AddInformation/DeleteInformation/DeleteSubject">
            <input type="hidden" name="Deleting" value="Subject" />
            <p class="input-background">
              <span class="text">Оберіть предмет для видалення:</span>
