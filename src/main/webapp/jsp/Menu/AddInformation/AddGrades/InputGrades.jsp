...
<html lang="uk-UA">
  ...
  <body>
    <center>
      ...
      <form method="POST" action="${pageContext.request.contextPath}/jsp/Menu/AddInformation/SaveGrades">
      ...
      <form method="POST" action="${pageContext.request.contextPath}/jsp/Menu/AddInformation/TurnThePage">
